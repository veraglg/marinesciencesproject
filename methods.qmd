...
## Theoretical principle: Biological oxygen demand as a proxy for biodegradation {#sec-methods-proxy}
...
BOD was calculated using the @eq-bod from the OxiTop\textregistered \space Control operating manual [@wtw2006] where $M_{O_2}$ is oxygen gas molecular weight (mg O~2~ mol^-1^), $R$ is the gas constant (L hPa mol^-1^ K^-1^), $T$ is temperature (K), $T_0$ is the reference temperature of 273.15 K (0 °C), $\alpha$ is the Bunsen absorption coefficient, $V_t$ is the total volume of the vessel (mL), and $V_m$ is the volume occupied by the two-phased medium (mL).
