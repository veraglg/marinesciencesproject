...
## No visual signs of biodegradation for recovered Ecovio\textregistered\ {.unnumbered}
...
![Recovered testing materials ---Ecovio\textregistered\ and cellulose--- after 30-days inside a simulated benthic environment. For each picture, Ecovio\textregistered\ at the top and cellulose at the bottom. A: Lake environment. B: Marine environment.](images/results-visual.jpg){#fig-visual}

## Negative result of Ecovio\textregistered\ BOD tests for every environment {.unnumbered}

Generally, plastic tests remained close to the baseline established by negative control tests, while positive control tests performed a fast BOD increase since the start of the incubation. In @tbl-bod the minimum, median, and maximum BOD after 30 days (BOD~30~) is represented. Marine tests varied over a narrower range compared to lake, which showed higher heterogeneity between tests. This range indicates a relatively more diverse microbial community in lake. A positive respirometrical response for positive control tests became evident after 10 days for the lake environment and 20 days for the marine environment, as illustrated in @fig-bod.
...
## Nonlinear models of higher complexity fit observed data more accurately {.unnumbered}
