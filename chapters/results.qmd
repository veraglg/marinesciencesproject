...
![Recovered testing materials after 30-days inside a simulated benthic environment. Ecovio\textregistered\ at the top and cellulose (+C) at the bottom. A: Lake. B: Sea.](/images/results-visual.jpg){#fig-visual width="10.5cm"}
...
```{r}
#| label: fig-bod
#| fig-cap: BOD evolution summary. Median and min-max range represented.
#| fig-height: 3
